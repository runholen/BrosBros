...
public class Door extends GameObject{
	...
	public Door() throws Exception{
		...
		alternateImage5 = ImageIO.read(getClass().getResourceAsStream("/resources/cannon.png"));
		alternateImage5 = GameFrame.scale(alternateImage5);
	}
}